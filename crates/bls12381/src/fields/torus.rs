...
impl<F: PrimeField + PrimeFieldBits> Torus<F> {
        ...
        CS: ConstraintSystem<F>,
    {
        ...
        let v0 = AllocatedE2Element::<F>::from_dec(("877076961050607968509681729531255177986764537961432449499635504522207616027455086505066378536590128544573588734230", "877076961050607968509681729531255177986764537961432449499635504522207616027455086505066378536590128544573588734230"))?;
        ...
        CS: ConstraintSystem<F>,
    {
        ...
        let v0 = AllocatedFieldElement::<F>::from_dec("4002409555221667392624310435006688643935503118305586438271171395842971157480381377015405980053539358417135540939437")?;
        let t0 =
